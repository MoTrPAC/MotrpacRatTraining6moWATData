...
#'   not accepted.
#' @param power integer; optional soft power. If not specified, the lowest value
#'   of `powerVector` that satisfies scale-free fit R^2 at least equal to
#'   `RsquaredCut` will be used.
#' @param powerVector integer vector of soft powers to check. Values should not
#'   exceed 30.
