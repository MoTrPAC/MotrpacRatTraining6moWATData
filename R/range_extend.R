...
#'
#' @description `range_extend` returns a vector containing the minimum and maximum of all the given arguments rounded outward to the value provided by `nearest`.
#'
...
#'
#' @returns A \code{\link[base]{numeric}} vector of length 2 specifying the range of values after
#'   rounding outward to the value provided by `nearest`.
#'
